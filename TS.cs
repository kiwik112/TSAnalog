...
namespace TSAnalog
{
    ...
    internal class TS
    {
        ...
        public static string[] getData()
        {
            ...
            {
                DialogResult result = MessageBox.Show("Locomotive did not report name and/or it's controls. Do you wan't to restart the application?", "Loco error", MessageBoxButtons.YesNo);
